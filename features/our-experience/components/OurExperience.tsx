...
const ExperienceCard = ({
  ...
  return (
    <a href="#" className="group">
      <div className="pl-6 pr-10 mb-5 pt-8 pb-6 md:h-[500px] w-full border bg-charcoal-900 flex flex-col justify-between items-start">
    ...
    <div>
      <section className="bg-charcoal-700 pt-16 pl-4 pr-2 flex flex-col lg:grid lg:grid-cols-[1fr_2fr] lg:gap-x-12 lg:-center">
        ...
        <div className="lg:sticky top-28 mb-18 h-min">
          <h2 className="title-sm-text">Our Experience</h2>

          <h3 className={inter.className + ' text-3xl text-white my-9'}>
